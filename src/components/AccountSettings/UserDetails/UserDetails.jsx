...
export default function UserDetails({
  ...
  let updateInput = (data) => {
    ...
    newInputState[Object.keys(data)[0]] === true
      ? (newInputState[Object.keys(data)[0]] = false)
      : (newInputState[Object.keys(data)[0]] = true);
  ...
  return (
    <div>
      ...
      <div className={styles.usr_detail_body}>
        ...
        <div className={styles.usr_detail_box}>
          ...
          <img
            ...
            onClick={() =>
              updateInput(
                inputState?.email ? { email: false } : { email: true }
              )
            }
          />
        </div>
        <div className={styles.usr_detail_box}>
          ...
          <img
            ...
            className={styles.usr_detail_edit}
            onClick={() =>
              updateInput(inputState.phone ? { phone: false } : { phone: true })
            }
          />
        </div>
        <div className={styles.usr_detail_box}>
          ...
          <img
            ...
            className={styles.usr_detail_edit}
            onClick={() => {
              updateInput(inputState.dob ? { dob: false } : { dob: true });
              setShowCalendar((prev) => !prev);
            }}
          />
        </div>
      ...
      <div
        className={
          showCalendar ? "acc_calendar acc_calendar_active" : "acc_calendar"
        }
      >
        <Calendar
          onChange={onChange}
          value={value}
          onClickDay={updateCalendar}
        />
      </div>
    </div>
  );
