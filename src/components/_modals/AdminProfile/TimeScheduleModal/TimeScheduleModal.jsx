...
const TimeScheduleModal = ({ closeEditModal, openEditModal, closeLeaveModal, openLeaveModal, handleShift, isLeave, isEdit, employeeSchedule }) => {

    return (
        <div>
            <div className={sty.editContent1}>

                {handleShift && <div className={sty.editContent}>
                    <div>

                        {isEdit && <EditAdminModal onClose={closeEditModal} />}
                        <p onClick={openEditModal}>Edit this shift</p>
                    </div>
                    <p onClick={employeeSchedule}>Edit Employee Schedule</p>
                    <div>

                        {isLeave && <AddLeaveModal onClose={closeLeaveModal} />}
                        <p onClick={openLeaveModal}>Add Leave</p>
                    </div>
