        ...
        <div className={`${styles.profileMain} `}>
            ...
            <div className={`${styles.profileA} ${isCameraOpen ? styles.hidden : ""}`}>
                ...
                <div className={styles.saveButtons}>
                    <SecondaryButton className={styles.cancelbtn} onClick={handleCancel}>Cancel</SecondaryButton>
                    <PrimaryButton className={styles.cancelbtn} onClick={handleSave}>Update</PrimaryButton>
                </div>
            </div>
        </div>
    );
