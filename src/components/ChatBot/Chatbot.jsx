...
function Chatbot() {
    ...
    const inputData = async (queData) => {
        ...
        if (res) {
            ...
            setQuetions([...userQuetion, {
                que: queData, ans: "Something went wrong!"
            }])
            console.log(err);
        }
        setUserInput('');
    ...
    return (
        <>
            ...
            <div onClick={(() => {
                ...
                {openMessage ? <><svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
