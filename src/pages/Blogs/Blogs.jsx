  ...
  let handlePagination = (pageNum = 1) => {
    if (blogData.length) {
      ...
      if (pageNum !== 1) {
        ...
        for (
          let index = startNum;
          index < (pageNum > 2 ? startNum + diff : startNum + perPage);
          index++
        ) {
    ...
    <div className={styles["AllBlogsPage"]}>
      ...
      <div className={styles["blog-section-container"]}>
        ...
        <div className={styles["Allblogs-container"]}>
          <Link
            to={firstBlogData ? `/blogs/${firstBlogData._id}` : ""}
          ...
          >
            ...
            <div className={styles["AllBlogsPageAB"]}>
          ...
          <div className={styles["AllBlogsPageB"]}>
            {blogData.length
              ? blogData.map((blog, i) => {
                  if (i <= 3) {
                    return <NewBlogCard blog={blog} key={i} />;
                  }
                })
              : ""}
          </div>
